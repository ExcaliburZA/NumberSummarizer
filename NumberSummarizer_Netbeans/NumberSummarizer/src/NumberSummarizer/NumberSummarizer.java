...
public class NumberSummarizer implements NumberRangeSummarizer{
    ...
    public Collection<Integer> collect(String input) {
        ...
        try {                                    
            ...
            //checking if the input String contains integer values to parse
            if(input.length() > 0){
                ...
                nums.add(0);    //adding a single 0 to indicate that the input String is empty
